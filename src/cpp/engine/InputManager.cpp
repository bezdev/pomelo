...
{
    if (data.Action == InputAction::DOWN) m_KeyDownVector[static_cast<size_t>(event)] = true;
    else if (data.Action == InputAction::UP) m_KeyDownVector[static_cast<size_t>(event)] = false;
