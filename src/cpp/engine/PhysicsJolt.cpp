...
void PhysicsJolt::AddEntity(ENTITY entity)
{
    ...
    if (HAS_COMPONENT(entity, Components::CollisionBox)) {
        ...
        LOGD("extends: %f, %f, %f", collisionBox.Extents.x, " ", collisionBox.Extents.y, " ", collisionBox.Extents.z);
        ...
        JPH::BodyCreationSettings sphereSettings(
            new JPH::SphereShape(collisionSphere.Radius),
        ...
        JPH::BodyID id = m_BodyInterface->CreateAndAddBody(
            sphereSettings,
            static_cast<JPH::EActivation>(collisionSphere.ActivationType)
        );
